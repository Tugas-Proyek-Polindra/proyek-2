...
<html lang="en">
  ...
  <body>    
    ...
    <div class="container">  
      ...
      <!-- List Order -->
          <h3 class="text-center p-3"><span>KATEGORI LAYANAN KONVEKSI PRODUK PADA KAFKA</span> </h3>
            ...
            <div class="row justify-content-center ms-4">
                <div class="col-md-3 col-sm-3">
                    <div class="card" style="width: 16rem;">
                        ...
                        <div class="card-body">
                          <h4 class="card-title">Sablon Kaos</h4>
                ...
                <div class="col-md-3 col-sm-3">
                    <div class="card" style="width: 16rem;">
                        ...
                        <div class="card-body">
                          <h4 class="card-title">Sablon Jahit</h4>
                          <a href="/pemesanan/create" class="btn btn-primary">Pemesanan</a>
                        </div>
                      </div>
                </div>
                <div class="col-md-3 col-sm-3">
                    <div class="card" style="width: 16rem;">
                        ...
                        <div class="card-body">
                          <h4 class="card-title">Jarsey Printing</h4>
                          <a href="/pemesanan/create" class="btn btn-primary">Pemesanan</a>
                        </div>
                      </div>
                </div>
                ...
                <div class="row justify-content-center m-4">
                        ...
                        <div class="col-lg-3">
                          ...
                          <div class="card ms-2" style="width: 16rem;">
                              ...
                              <div class="card-body">
                                <h5 class="card-title">Marchandice Printing</h5>                                
                                <a href="/pemesanan/create" class="btn btn-primary">Pemesanan</a>
                              </div>
                            </div>
                      </div>
